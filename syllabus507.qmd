...
The group assignment will have four deliverables: 1) a group roles contract (details will be provided on Brightspace) submitted for instructor review (due **March 6th**); 2) an outline of the group's approach to the case (due **March 10th**); 3) the final case study report (due **May 4th**); and 4) a group final presentation video, which can be done as a recorded Zoom with screenshare for slides and a polished presentation from all members (due **May 4th**).
